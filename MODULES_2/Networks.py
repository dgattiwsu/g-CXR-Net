...
# In[1]
from MODULES_2.Blocks import * 
from MODULES_2.Constants import _Params
from MODULES_2.Attention import *
...
def ResNet(input_shape_1=(HEIGHT, WIDTH, CHANNELS),
    ...
    if prep:        
        d0 = SpatialDropout2D(sp_dropout,data_format='channels_last')(d0)
    ...
    for cycle in range(resblock1):
        ...
        d1 = SpatialDropout2D(sp_dropout,data_format='channels_last')(d1)            
